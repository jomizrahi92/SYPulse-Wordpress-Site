<?php get_header(); ?>	
	...
	<?php if ( wptouch_have_posts() ) { ?>
		...
		<div class="<?php wptouch_post_classes(); ?> rounded-corners-8px">
			<div class="title-area" role="heading">
			...
			<div class="post-navigation nav-bottom dark-gradient">
				<div role="button" class="post-nav-fwd"  title="<?php _e( "next post", "wptouch-pro" ); ?>">
					<?php classic_get_next_post_link(); ?>
				</div>	
				<div role="button" class="post-nav-back"  title="<?php _e( "previous post", "wptouch-pro" ); ?>">
			...
			<?php if ( classic_show_share_single() ) { ?>					
				<div class="aligncenter">
					<a role="button" class="share-post wptouch-button no-ajax" href="javascript:void(0);"><?php _e( "Share or Save This Post", "wptouch-pro" ); ?></a>
