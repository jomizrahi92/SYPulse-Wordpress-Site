...
* Added: BlackBerry 10 User Agent
* Fixed: An issue that could prevent custom backgrounds from appearing in Classic theme
...
* Changed: Web-App title input now maxes out at 12 characters (respects iOS 6 title limitation)
...
* Changed: Reduced plugin zip file size to 3.1MB (from 6MB)
...
* Changed: Updated admin information regarding inclusion of desktop functions.php file
